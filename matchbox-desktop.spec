...
Summary(pl):	¦rodowisko Matchbox Desktop
...
%description -l pl
¦rodowisko Matchbox Desktop.

%package devel
Summary:	Header files for Matchbox Desktop modules
Summary(pl):	Pliki nag³ówkowe dla modu³ów Matchbox Desktop
...
Pliki nag³ówkowe dla modu³ów Matchbox Desktop.
